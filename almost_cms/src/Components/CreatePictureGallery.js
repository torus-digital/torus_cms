...
export default function createGallery(){
	...
	.then (result => {
		...
		const pregallery = `<section class="p-0" id="portfolio"> <div class="container-fluid p-0"> <div class="row no-gutters popup-gallery">`
		...
		const scripts = `<script src="../vendor/jquery/jquery.min.js"></script> <script src="../vendor/bootstrap/js/bootstrap.bundle.min.js"></script> <script src="../vendor/jquery-easing/jquery.easing.min.js"></script> <script src="../js/gallery.js"></script> </body> </html>`
		const contentType = 'text/html';
		var gallery = '';
		for (let pic of pictures) { 
			gallery += (
				`<div class="col-lg-4 col-sm-6">
					<a class="portfolio-box" href="${pic.file}">
